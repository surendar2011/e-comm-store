...
import { ArrowLeft, User, Mail, Calendar, DollarSign, Package } from "lucide-react";
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <select
            ...
            disabled={isPending}
            className="px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 disabled:opacity-50"
          >
